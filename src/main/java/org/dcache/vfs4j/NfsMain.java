...
public class NfsMain {
	...
	//1. Read conf from xml file, including all data storage, data region and cache configuration
	...
	//comment this line out if you use cache configuration in the code
	IgniteCache<String, byte[]> cache = ignite.getOrCreateCache("content-access-cache");


	//***Or 2. Create conf in code***
	...
	//Add this line if use Ignite Configuration in code
	//   Ignite ignite = Ignition.start(igniteConfiguration); 


	//*** create CacheConfiguration in code ****
